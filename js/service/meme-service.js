...
function createImages() {
    ...
    if (!imgs) {
        imgs = [
            ...
            _createImage('./Meme-generator/main/assets/6.jpg', ['aliens', 'history', 'guy']),
            _createImage('./Meme-generator/main/assets/7.jpg', ['funny', 'cute', 'baby', 'supriesed']),
            _createImage('./Meme-generator/main/assets/8.jpg', ['willi', 'tell']),
            _createImage('./Meme-generator/main/assets/9.jpg', ['evil', 'cute', 'baby', 'laugh']),
            _createImage('./Meme-generator/main/assets/10.jpg', ['obama', 'laugh', 'smile', 'celeb']),
            _createImage('./Meme-generator/main/assets/11.jpg', ['kiss', 'guy', 'basketball']),
            _createImage('./Meme-generator/main/assets/12.jpg', ['finger', 'point']),
            _createImage('./Meme-generator/main/assets/13.jpg', ['decaprio', 'cheers', 'smile']),
            _createImage('./Meme-generator/main/assets/14.jpg', ['matrix', 'sunglasses']),
            _createImage('./Meme-generator/main/assets/15.jpg', ['mordor', 'guy', 'rings', 'lord']),
            _createImage('./Meme-generator/main/assets/16.jpg', ['guy', 'star', 'smile']),
            _createImage('./Meme-generator/main/assets/17.jpg', ['putin', 'suit', 'two']),
            _createImage('./Meme-generator/main/assets/18.jpg', ['toy', 'buzz', 'woddy']),
        ]
    }
    gImgs = imgs
    _saveImgsToStorage()
